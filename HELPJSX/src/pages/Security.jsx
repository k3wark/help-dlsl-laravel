...
export default function Security(){
    ...
    const Submitting = (ev) => {
        ev.preventDefault();
        axiosClient.post(`/security`, distress)
                .then( ({data}) => {
                    navigate("/SOS");
                })
                .catch( () =>{
                    ...
                    <div className='emsLeft'>
                        <div className='emsRadio'>
                            ...
                            <div className='emsRadioOptions'>
                                <label><input type='radio' name='concernSelect' onChange={ ev => setDistress( {...distress, Concern: ev.target.value} )} value='Harassment'/><span className='conditionOption'>Harassment</span></label>
                                <label><input type='radio' name='concernSelect' onChange={ ev => setDistress( {...distress, Concern: ev.target.value} )} value='Missing Item'/><span className='conditionOption'>Missing Item</span></label>
                                <label><input type='radio' name='concernSelect' onChange={ ev => setDistress( {...distress, Concern: ev.target.value} )} value='Commotion'/><span className='conditionOption'>Commotion</span></label>
                                <label><input type='radio' name='concernSelect' onChange={ ev => setDistress( {...distress, Concern: ev.target.value} )} value='Missing Person'/><span className='conditionOption'>Missing Person</span></label>
                            </div>
                        </div>
